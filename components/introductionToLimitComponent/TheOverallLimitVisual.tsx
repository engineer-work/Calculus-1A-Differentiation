...
// --- Static Component to protect MathJax from Re-renders ---
// This component is memoized so it does not re-render when the parent state (sliders) changes.
// This prevents React from overwriting the MathJax-processed DOM with the raw LaTeX string.
const GoldenRuleCard = React.memo(() => {
  return (
